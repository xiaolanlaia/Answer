...
public class CreateRandomExamBean {
    public int code;
    public String message;
    public List<MainValueBean>value;

    public static class MainValueBean{
        public long id;
    ...
    public List<MainValueBean> getValue() {
        return value;
    }

    public void setValue(List<MainValueBean> value) {
        this.value = value;
    }
}
